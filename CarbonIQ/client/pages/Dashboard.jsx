    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [statsData, trendData, emittersData, activitiesData] = await Promise.all([
          ...
          getEmissionsTrend(userId),
          getTopEmitters(userId),
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 min-w-[240px] flex-1">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.totalEmission} kg</p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 min-w-[240px] flex-1">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.thisMonth} kg</p>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200 min-w-[240px] flex-1">
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900">{stats.activitiesLogged}</p>
            ...
            <div className="h-80">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={emissionsData}>
                  ...
                  <YAxis stroke="#9ca3af" style={{ fontSize: '12px' }} label={{ value: 'kg CO₂', angle: -90, position: 'insideLeft' }} />
          ...
          <div className="flex-1 bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div className="flex items-center justify-between gap-6">
              <div className="w-48 h-48 flex-shrink-0">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie data={topEmittersData} cx="50%" cy="50%" outerRadius={80} dataKey="value" strokeWidth={0}>
                ...
                <div className="flex items-center gap-4 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded font-medium">{activity.badge}</span>
                    </div>
